        ...
        public void test()
        {
            var xml = @"
                < doc >
                    ...
                    < members >
                        < member name =""M:QWebAPI.Controllers.ExpressController.GetQParcelList"" >
                         ...
                         < member name = ""T:QWebAPI.Controllers.UserController"" >
            ...
            XPathNavigator _navigator = new XPathDocument("H://QWebApi.XML").CreateNavigator();
            var typeNode = _navigator.Select(MemberXPath);
            ...
            doc.LoadXml(xml);
            var employees = doc.SelectNodes(MemberXPath);

        }
        [Test]
        public void It_documents_operations_from_action_summary_and_remarks_tags_including_paramrefs()
        {
            var swagger = GetContent<JObject>("http://localhost/ququton/swagger/docs/v1");
